...
For provider setup, adding more social providers, and environment checklists, see [OAuth / social sign-in](oauth-social-sign-in.md).
...
- [OAuth / social sign-in](oauth-social-sign-in.md) — OAuth / social sign-in plan, Console setup, adding providers, checklist
